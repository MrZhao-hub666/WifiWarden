...
| 模块 | 能力 |
|------|------|
| **802.11 帧嗅探** | Probe Request / Beacon / Deauth 三类管理帧捕获 |
| **Deauth 攻击检测** | 5 秒滑动窗口，阈值可配，声光告警联动 |
| **高危端口扫描** | TCP Connect 扫描 11 个高危端口 |
| **弱口令检测** | HTTP Basic Auth / Telnet / FTP，200+ 组密码字典 |
| **后台路径枚举** | 30+ Web 管理后台常见路径探测 |
| **MAC 黑名单** | 拉黑即时踢除，重连继续封禁，全链路同步 |
| **蜜罐诱捕** | Telnet 假 Shell + HTTP 假登录页，捕获攻击行为 |
| **AI 分析** | 自动调 DeepSeek 评估威胁等级并生成防御建议 |
| **ST7789 屏幕** | 实时显示 AP 状态 / 扫描结果 / 蜜罐 / 告警 |
